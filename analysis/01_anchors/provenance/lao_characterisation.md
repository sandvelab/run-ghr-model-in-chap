...
produced: 2026-09-21
alternatives-considered: the data could have been left uncharacterised, since this project
  does not model it; rejected because a later batch is handed these files by two independent
  agents and needs a file-grounded way to confirm that what was evaluated is what was
  archived. Summary statistics of the climate covariates were also reasonable and were left
  out: the target and the shape of the panel are what a route's evaluation depends on, and
  a wider characterisation would invite reading this node as data analysis, which it is not.
